    ...
    const loadReviews = async () => {
      try {
        ...
        if (data.success) {
          ...
          // Commencer avec 0 avis, ne pas ajouter d'avis par défaut
        }
      } catch (error) {
        console.error('Erreur lors du chargement des avis:', error);
        // En cas d'erreur, commencer avec 0 avis
        setReviews([]);
      } finally {
          ...
          <div className={`space-y-6 sm:space-y-8 transform transition-all duration-1000 ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'} md:order-2`}>
            ...
            <div className="flex flex-col sm:flex-row gap-4 items-center sm:items-start transform transition-all duration-1000 delay-500">
              ...
              <Button 
                ...
                size="lg"
                variant="outline"
                className="border-2 border-blue-600 text-blue-600 hover:bg-blue-600 hover:text-white bg-transparent transition-all duration-300 cursor-pointer flex items-center transform hover:scale-105 rounded-full"
              >
                Nous contacter
              ...
              <Button 
                ...
                size="lg"
                variant="outline"
                className="border-2 border-yellow-400 text-yellow-700 hover:bg-yellow-400 hover:text-white bg-transparent transition-all duration-300 flex items-center transform hover:scale-105 rounded-full"
              >
            ...
            <div className="relative w-full h-96 md:h-[500px] lg:w-4/5 lg:mx-auto rounded-2xl overflow-hidden shadow-2xl transform transition-all duration-300 hover:scale-105">
              ...
              <div className="absolute bottom-0 left-6 right-6 text-white pb-2">
                ...
                <Link href="/reviews" className="group">
                  <p className="text-sm sm:text-lg font-semibold mt-2 mb-2 group-hover:text-blue-600 transition-colors cursor-pointer">
                    Plus de {reviews.length}+ clients satisfaits à Bouaké
                  </p>
                </Link>
                ...
                <button 
                  ...
                  className="text-sm px-4 py-2 rounded-full font-semibold border border-yellow-400 text-yellow-700 hover:bg-yellow-400 hover:text-white bg-transparent transition-all duration-300"
                >
